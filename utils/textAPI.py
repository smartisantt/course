...
from parentscourse_server.config import TEXT_AUDIO_TIMEOUT
...
class TextAudit(object):
    ...
    def get_token(self):
        ...
        try:
            if re.status_code == 200:
                ...
                caches['client'].set("textAudioToken", self.access_token, TEXT_AUDIO_TIMEOUT)
    ...
    def work_on(self, text):
        """执行审核"""
        self.access_token = caches['client'].get("textAudioToken")
