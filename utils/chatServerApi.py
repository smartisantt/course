...
# 开发平台注册的key和secret
AppKey = "c8d1359910c8d4d26b8fe061d5f23c37"
AppSecret = "d99212973861"
...
class ServerAPI():
    ...
    def checkSumBuilder(self):
        ...
        self.CheckSum = hashlib.sha1(join_string).hexdigest()
     ...
     * @param  option       [发消息时特殊指定的行为选项,Json格式，可用于指定消息的漫游，存云端历史，发送方多端同步，推送，消息抄送等特殊行为option中字段不填时表示默认值]
